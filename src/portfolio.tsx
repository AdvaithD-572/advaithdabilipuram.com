...
function useHash() {
  const read = () => location.hash || location.pathname || '#/';
...
export function Portfolio() {
  ...
  useEffect(() => { applyRouteMetadata(route, project?.name); }, [route, project]);
